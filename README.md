...
Para executar outros cenários de simulação, o usuário pode alterar o tipo de canal por meio do parâmetro Channel, modificar a SNR em dB, escolher diferentes técnicas de sensoriamento espectral ajustando Sepec_Sens_Technique, ou ainda alterar N_pts para gerar curvas ROC com maior resolução.
